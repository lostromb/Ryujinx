...
namespace Ryujinx.Graphics.Gpu.Image
{
    ...
    class Texture : IMultiRangeItem, IDisposable
    {
        ...
        public void SynchronizeFull()
        {
            ...
            PooledSpan pooledData = ConvertToHostCompatibleFormat(data);

            HostTexture.SetData(pooledData);
        ...
        public PooledSpan ConvertToHostCompatibleFormat(ReadOnlySpan<byte> data, int level = 0, bool single = false)
        {
